...
router.get('/users', authMiddleware.authenticateRequired, async (req, res, next) => {
  try {
...
router.post('/users', authMiddleware.authenticateRequired, async (req, res, next) => {
  try {
...
router.get('/users/:user_id', authMiddleware.authenticateRequired, async (req, res, next) => {
  try {
...
router.put('/users/:user_id', authMiddleware.authenticateRequired, async (req, res, next) => {
  try {
...
router.delete('/users/:user_id', authMiddleware.authenticateRequired, async (req, res, next) => {
  try {
