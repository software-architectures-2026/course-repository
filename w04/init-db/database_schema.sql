...
VALUES
  (gen_random_uuid(), 'alice@example.com', 'hash1', 'Alice Smith', 'active', NOW(), NOW()),
  (gen_random_uuid(), 'bob@example.com', 'hash2', 'Bob Johnson', 'active', NOW(), NOW()),
  (gen_random_uuid(), 'carol@example.com', 'hash3', 'Carol Lee', 'deactivated', NOW(), NOW());
